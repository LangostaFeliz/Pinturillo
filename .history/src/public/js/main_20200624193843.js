...
// chatBox 
   ...
   mensajeForm.submit(e=>{
    ...
    //            // 
    //             og.lineTo( data.moveX,data.moveY);
    //             //og.fillRect(data.moveX,data.moveY,5,5)=function(){
    //             og.stroke();
    //           //  og.beginPath();
...
window.onload = function (){
    ...
    function canvaLoop(){
        if(mouse.click && mouse.move && mouse.pos_prev){
            socket.emit('draw line',{line:[mouse.pos,mouse.pos_prev,canva.strokeStyle]});
            mouse.move = false;
        }
...
//     oc[0].addEventListener('mousedown',function (){
//         console.log("cliendo");
//     })
